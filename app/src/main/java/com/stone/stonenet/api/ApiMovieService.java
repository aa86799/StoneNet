...
public interface ApiMovieService {
    ...
    @GET("top250")
    Observable<MovieBean> getTopMovies1(@Query("start") int start, @Query("count") int count);

    @GET
    Observable<MovieBean> getTopMovies2(@Url String url, @Query("start") int start, @Query("count") int count);

    @GET("{path}")
    Flowable<MovieBean> getTopMovies3(@Path(value = "path", encoded = true) String path,
